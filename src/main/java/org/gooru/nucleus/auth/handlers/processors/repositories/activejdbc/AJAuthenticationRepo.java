...
public class AJAuthenticationRepo implements AuthenticationRepo {
  ...
  public MessageResponse createAnonymousAccessToken() {
    return TransactionExecutor.executeTransaction(AuthenticationExecutorFactory.createAnonymousAccessToken(messageContext));
  }
  ...
  public MessageResponse createBasicAuthAccessToken() {
    return TransactionExecutor.executeTransaction(AuthenticationExecutorFactory.createBasicAuthAccessToken(messageContext));
  }
}
