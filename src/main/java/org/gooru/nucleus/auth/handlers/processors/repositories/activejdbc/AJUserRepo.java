...
public class AJUserRepo implements UserRepo {
    ...
    public MessageResponse resetAuthenticateUserPassword() {
        return TransactionExecutor
            .executeTransaction(UserExecutorFactory.resetAuthenticateUserPassword(messageContext));
    }
    ...
    public MessageResponse resetUnAuthenticateUserPassword() {
        return TransactionExecutor.executeTransaction(UserExecutorFactory
            .resetUnAuthenticateUserPassword(messageContext));
    }
