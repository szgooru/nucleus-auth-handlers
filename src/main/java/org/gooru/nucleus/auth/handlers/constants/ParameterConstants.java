...
public class ParameterConstants {
    ...
    public static final String PARAM_USER_CATEGORY = "user_category";
    public static final String PARAM_USER_BIRTH_DATE = "birth_date";
    public static final String PARAM_USER_GENDER = "gender";
    public static final String PARAM_USER_ABOUT_ME = "about_me";
    ...
    public static final String MAIL_CC_ADDRESSES = "cc_addresses";
