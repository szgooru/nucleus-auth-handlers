...
import org.gooru.auth.handlers.processors.messageProcessor.AuthenticatonMessageProcessor;
  ...
  public void start(Future<Void> voidFuture) throws Exception {
    ...
    eb.consumer(MessagebusEndpoints.MBEP_AUTHENTICATION, message -> {
      ...
      vertx.executeBlocking(future -> {
        MessageResponse result = new ProcessorBuilder(AuthenticatonMessageProcessor.class, message).build().process();
