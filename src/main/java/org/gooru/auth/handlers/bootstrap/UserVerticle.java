...
import org.gooru.auth.handlers.processors.command.executor.UserCommandExecutor;
  ...
  public void start(Future<Void> voidFuture) throws Exception {
    ...
    eb.consumer(MessagebusEndpoints.MBEP_USER, message -> {
      ...
      vertx.executeBlocking(future -> {
        MessageResponse result = new ProcessorBuilder(UserCommandExecutor.class, message).build().process();
